...
@Component({
  selector: 'app-tech-timeline-page',
  templateUrl: './tech-timeline-page.component.html',
  styleUrls: ['./tech-timeline-page.component.scss'],
})
export class TechTimelinePageComponent {
  starterYear = 2006;
